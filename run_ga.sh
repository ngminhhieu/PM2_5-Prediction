...
tmux send-keys -t real "tmux send-keys -t best_only_false 'python3 main.py --pc=0.8 --pm=0.2 --gen=2 --population=2 --select_best_only=false' ENTER" ENTER
tmux send-keys -t real "tmux send-keys -t best_only_true 'python3 main.py --pc=0.8 --pm=0.2 --gen=2 --population=2 --select_best_only=true' ENTER" ENTER
